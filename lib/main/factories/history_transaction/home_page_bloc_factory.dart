...
import 'package:simple_financial_records/main/factories/history_transaction/update_finance_factory.dart';
...
class HistoryTransactionPageBlocFactory{
  static HistoryTransactionPageBloc createHistoryTransactionPageBloc(){
    return HistoryTransactionPageBloc(LoadFinanceFactory.createLoadFinanceUseCase(), DeleteFinanceFactory.createDeleteFinanceUseCase(), UpdateFinanceFactory.createUpdateFinanceUseCase());
  }
}
  ...
  runApp(MultiBlocProvider(
    providers: [
      BlocProvider<HomePageBloc>(
          create: (context) => HomePageBlocFactory.createHomePageBloc()),
      BlocProvider<HistoryTransactionPageBloc>(
          create: (context) => HistoryTransactionPageBlocFactory
              .createHistoryTransactionPageBloc()),
    ],
    child: const MyApp(),
  ));
}
